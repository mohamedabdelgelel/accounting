...
<script>
    $(document).ready(function() {
        ...
        $('.myform').submit(function() {
            if (confirm('هل ان متأكد من حذف العائد؟')) {
    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-8 col-12 mb-2">
                <center>
                <h3 class="content-header-title font-theme ls-0">قائمة الايرادات</h3>
                </center>
            </div>
            <div class="content-header-right col-md-4 col-12 mb-2">
                <a href="{{url('admin/revenues/create')}}" class="btn btn-primary" ><i class="icon-plus"></i> إضافة </a>
            </div>
        </div>
...
{{--                                        <a href="#" class="btn btn-icon btn-sm btn-danger"><i class="ft-trash-2"></i></a>--}}
                                        ...
                                        <form class="myform"  id="{{$driver->id}}"  method="post"  action="{{(route('revenues.destroy',$driver->id))}}">
                                            @csrf
                                            <a href="{{(route('revenues.edit',$driver->id))}}" class="btn btn-success a-btn-slide-text">
