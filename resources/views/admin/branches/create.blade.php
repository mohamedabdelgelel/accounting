                ...
                <div class="card">
                    <div class="card-block">
                        ...
                        <div class="card-body">
                            ...
                            <form id="add-form" action="{{route('branches.store')}}" method="post">
                                @csrf
                                                ...
                                                <div class="card-body table-responsive p-0" style="height:250px;">
                                                    <table class="table table-head-fixed text-nowrap table-striped-td table-input-td text-center" id="add-table">
                                                        ...
                                                        <tr id="entryrow_1">
                                                            ...
                                                            <td><input type="text" class="form-control bg-transparent border-0 inputs sal-lst" id="debtor_1" name="codes[]"></td>
