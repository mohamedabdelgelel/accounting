    ...
    <div class="content-wrapper">
        <div class="content-header row">
            ...
            <div class="content-header-right col-md-4 col-12 mb-2">
                <a href="{{url('admin/createHoliday')}}" class="btn btn-primary" ><i class="icon-plus"></i> إضافة </a>
            </div>
                ...
                <div class="card-block">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped datatabحالة الاجازةle">
                                <thead>
                                <tr>
                                    <th>تسلسل</th>
                                    <th>الموظف</th>
