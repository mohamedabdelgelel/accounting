...
<head>
    ...
    <title>Everest ERP System - Reports</title>
    <!-- Google Fonts -->
            ...
            <div class="collapse navbar-collapse order-3" id="navbarCollapse">
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle"><i class="nav-icon fas fa-tachometer-alt mr-1"></i>بيانات اساسيه</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li><a href="" class="dropdown-item">دليل الحسابات</a></li>
                            <li><a href="" class="dropdown-item">الفروع</a></li>
                            <li><a href="" class="dropdown-item">الشركات</a></li>
                            <li><a href="" class="dropdown-item">العملاء </a></li>
                            <li><a href="" class="dropdown-item" >الأصناف</a></li>
                            <li><a href="" class="dropdown-item">المندوبين</a></li>
                            <li><a href="" class="dropdown-item">الموردين</a></li>
                            <li><a href="" class="dropdown-item">مراكز التكلفة</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle"><i class="nav-icon fas fa-file-invoice mr-1"></i>المبيعات</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li><a href="" class="dropdown-item"  >فاتورة المبيعات</a></li>
                            <li><a href="#" class="dropdown-item">مردود المبيعات</a></li>
                            <li><a href="#" class="dropdown-item" data-toggle="modal" data-target="#sales-report">تقرير حركة المبيعات</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle"><i class="nav-icon fas fa-file-invoice mr-1"></i>المشتربات</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li><a href="" class="dropdown-item">فاتورة المشتربات</a></li>
                            <li><a href="#" class="dropdown-item">مردود المشتريات</a></li>
                            <li><a href="#" class="dropdown-item" data-toggle="modal" data-target="#purchases-report">تقرير حركة المشتريات</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle"><i class="nav-icon fas fa-file-alt mr-1"></i>الحسابات</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li><a href="" class="dropdown-item">سند صرف</a></li>
                            <li><a href="" class="dropdown-item">سند قبض</a></li>
                            <li><a href="" class="dropdown-item">القيود اليومية</a></li>
                            <li><a href="#" class="dropdown-item">التقارير اليومية العامة</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li><a href="#" class="dropdown-item" data-toggle="modal" data-target="#bond-conversion">سند تحويل مواد</a></li>
                            <li><a href="" class="dropdown-item">جرد مخازن</a></li>
                            <li><a href="#" class="dropdown-item">اذن صرف بضاعة</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a id="dropdownSubMenu1" href="" aria-haspopup="true"  class="nav-link "><i class="nav-icon fas fa-edit mr-1"></i>التقارير</a>

                    </li>
                    <li class="nav-item dropdown">
                        <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle"><i class="nav-icon fas fa-cogs mr-1"></i>أدوات</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li><a href="#" class="dropdown-item" data-toggle="modal" data-target="#add-employee">تسجيل موظف جديد</a></li>
                            <li><a href="#" class="dropdown-item" data-toggle="modal" data-target="#vacation-request">طلب اجازة</a></li>
                            <li><a href="#" class="dropdown-item" data-toggle="modal" data-target="#attend-report">بيان حضور وانصراف</a></li>
                            <li><a href="#" class="dropdown-item" data-toggle="modal" data-target="#deduction">الخصومات</a></li>
                            <li><a href="#" class="dropdown-item" data-toggle="modal" data-target="#advance">السلف</a></li>
                            <li><a href="#" class="dropdown-item" data-toggle="modal" data-target="#certificate">الوثائق والشهادات</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar " data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item mb-4">
                        <a href="" class="nav-link"><i class="nav-icon fas fa-th"></i><p>التقارير</p></a>
                    </li>
                    ...
                    <li class="nav-item mb-4">
                        <a href="" class="nav-link"><i class="nav-icon fas fa-file-invoice"></i><p>فاتورة المبيعات</p></a>
                    </li>
                    <li class="nav-item mb-4">
                        <a href="" class="nav-link"><i class="nav-icon fas fa-file-invoice"></i><p>فاتورة المشتريات</p></a>
                    </li>
                    <li class="nav-item mb-4">
                        <a href="" class="nav-link"><i class="nav-icon fas fa-file-invoice-dollar"></i><p>سند صرف</p></a>
                    </li>
                    <li class="nav-item mb-4">
                        <a href="" class="nav-link"><i class="nav-icon fas fa-file-invoice-dollar"></i><p>سند قبض</p></a>
                    </li>
...
<!--    --><?php
//    if (!empty($_SESSION["flashdata"]['error'])) {?>
<!--        <script>-->
<!---->
<!--            toastr.error('--><?php //echo $_SESSION["flashdata"]['error'];?>//')
//        </script>
//    <?php //}?>
<!--    --><?php
//    if (!empty($_SESSION["flashdata"]['success'])) {?>
<!--        <script>-->
<!---->
<!--            toastr.info('--><?php //echo $_SESSION["flashdata"]['success'];?>//')
//        </script>
    <?php //}?>
<!---->
    ...
    <footer class="main-footer text-center">
        <strong>جميع الحقوق محفوظة &copy; 2021 <a href="#">Everest ERP System</a>.</strong>
    </footer>
...
<script type='text/javascript'>
    ...
    var myArray = <?php echo json_encode($items); ?>;
